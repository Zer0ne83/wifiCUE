  ...
  return (function () {
    var e = {
        545: function (e, t, r) {
          ...
          function E(e, t) {
            y((t = Object.assign({ decode: !0, sort: !0, arrayFormat: "none", arrayFormatSeparator: ",", parseNumbers: !1, parseBooleans: !1 }, t)).arrayFormatSeparator);
            var r = (function (e) {
                var t;
              ...
              for (l.s(); !(i = l.n()).done; ) {
                ...
                if ("" !== u) {
                  var c = p(t.decode ? u.replace(/\+/g, " ") : u, "="),
                    ...
                    d = f[0],
                    m = f[1];
                  (m = void 0 === m ? null : ["comma", "separator", "bracket-separator"].includes(t.arrayFormat) ? m : h(m, t)), r(h(d, t), m, n);
                }
              }
            } catch (e) {
              l.e(e);
          ...
          (t.extract = b),
            ...
            (t.stringify = function (e, t) {
              if (!e) return "";
              y((t = Object.assign({ encode: !0, strict: !0, arrayFormat: "none", arrayFormatSeparator: "," }, t)).arrayFormatSeparator);
              for (
                var r = function (r) {
                    ...
                    switch (e.arrayFormat) {
                      case "index":
                        return function (t) {
                          return function (r, n) {
                            var o = r.length;
                            return void 0 === n || (e.skipNull && null === n) || (e.skipEmptyString && "" === n) ? r : [].concat(i(r), null === n ? [[m(t, e), "[", o, "]"].join("")] : [[m(t, e), "[", m(o, e), "]=", m(n, e)].join("")]);
                          };
                        };
                      case "bracket":
                        return function (t) {
                          return function (r, n) {
                            return void 0 === n || (e.skipNull && null === n) || (e.skipEmptyString && "" === n) ? r : [].concat(i(r), null === n ? [[m(t, e), "[]"].join("")] : [[m(t, e), "[]=", m(n, e)].join("")]);
                          };
                        };
                      case "colon-list-separator":
                        return function (t) {
                          return function (r, n) {
                            return void 0 === n || (e.skipNull && null === n) || (e.skipEmptyString && "" === n) ? r : [].concat(i(r), null === n ? [[m(t, e), ":list="].join("")] : [[m(t, e), ":list=", m(n, e)].join("")]);
                          };
                        };
                      case "comma":
                      case "separator":
                        ...
                        return function (r) {
                          return function (n, o) {
                            return void 0 === o || (e.skipNull && null === o) || (e.skipEmptyString && "" === o)
                              ? n
                              : ((o = null === o ? "" : o), 0 === n.length ? [[m(r, e), t, m(o, e)].join("")] : [[n, m(o, e)].join(e.arrayFormatSeparator)]);
                          };
                        };
                      default:
                        return function (t) {
                          return function (r, n) {
                            return void 0 === n || (e.skipNull && null === n) || (e.skipEmptyString && "" === n) ? r : [].concat(i(r), null === n ? [m(t, e)] : [[m(t, e), "=", m(n, e)].join("")]);
                          };
                        };
                    }
                  })(t),
            ...
            (t.parseUrl = function (e, t) {
              ...
              var r = p(e, "#"),
                ...
                a = n[0],
                i = n[1];
              return Object.assign({ url: a.split("?")[0] || "", query: E(b(e), t) }, t && t.parseFragmentIdentifier && i ? { fragmentIdentifier: h(i, t) } : {});
            }),
            (t.stringifyUrl = function (e, r) {
              ...
              return e.fragmentIdentifier && (u = "#".concat(r[d] ? m(e.fragmentIdentifier, r) : e.fragmentIdentifier)), "".concat(o).concat(l).concat(u);
            }),
    ...
    return (
      (function () {
        ...
        var v;
        function g(e, t) {
          var r = h.stringify(o(o({}, e), { parent: b(e.parent), referrer: document.location.href })),
            n = "https://".concat(t, ".twitch.tv"),
            a = "".concat(n, "?").concat(r),
            i = document.createElement("iframe");
          i.setAttribute("src", a), i.setAttribute("allowfullscreen", ""), i.setAttribute("scrolling", "no"), i.setAttribute("frameborder", "0"), i.setAttribute("allow", "autoplay; fullscreen"), i.setAttribute("title", "Twitch");
          var s = "allow-modals allow-scripts allow-same-origin allow-popups allow-popups-to-escape-sandbox";
          return (
            "function" == typeof document.hasStorageAccess && "function" == typeof document.requestStorageAccess && (s += " allow-storage-access-by-user-activation"),
        ...
        var _ = {
            ...
            quality: "",
            qualitiesAvailable: [],
            stats: { videoStats: { backendVersion: "", bufferSize: 0, codecs: "", displayResolution: "", fps: 0, hlsLatencyBroadcaster: 0, latencyMode: "", playbackRate: 0, skippedFrames: 0, videoResolution: "" } },
            videoID: "",
            volume: 0,
            ended: !1,
          },
            ...
            return (
              ...
              (r.prototype.destroy = function () {
                ...
                this._eventEmitter && this._eventEmitter.removeAllListeners(),
                  ...
                  null === (t = null === (e = this._iframe) || void 0 === e ? void 0 : e.parentNode) || void 0 === t || t.removeChild(this._iframe),
              ...
              (r.READY = s.READY),
              (r.SEEK = s.SEEK),
              (r.Errors = o({ ABORTED: p.Aborted, NETWORK: p.Network, DECODE: p.Decode, FORMAT_NOT_SUPPORTED: p.FormatNotSupported, CONTENT_NOT_AVAILABLE: p.ContentNotAvailable, RENDERER_NOT_AVAILABLE: p.RendererNotAvailable }, p)),
              r
            );
          })(d);
        var A = {
